    ...
    public class MapWidget implements IsWidget {
        ...
        public final native JavaScriptObject styleFunction() /*-{
            ...
            return function(feature, resolution) {
                ...
                return that.@org.ol3cesium.demo.client.examples.ol3cesium.Ol3CesiumVectorExample.MapWidget::getStyle(Ljava/lang/String;)(type);
            };
        }-*/;
...
//                            _olCesium.getCesiumScene().getGlobe().setDepthTestAgainstTerrain(false);
    ...
    public Ol3CesiumVectorExample(ShowcaseExampleStore store) {
        super("Vector ol3cesium", "Vectors are synchronized from the ol3 map to the Cesium scene.", new String[]{"openstreetmap", "ol3cesium", "cesium", "3d", "Vector"}, store);
    }
    ...
    public void buildPanel() {
        ...
        depthTestTbtn.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                boolean depthTestAgainstTerrain = olCesium.getCesiumScene().getGlobe().getDepthTestAgainstTerrain();
                olCesium.getCesiumScene().getGlobe().setDepthTestAgainstTerrain(!depthTestAgainstTerrain);
