...
import org.ol3cesium.ol.event.ViewChangeEventListener;
import org.ol3cesium.ol.geom.SimpleGeometry;
        ...
        if (!this.__viewChangeEventListenerRegistered) {
            ...
            this.__notifyViewChangeEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.ViewChangeEventListener::onViewChange(Lorg/ol3cesium/ol/event/ViewChangeEvent;)(event);
                }
            };
        }
