...
import org.ol3cesium.ol.event.GroupLayerChangeEventListener;
import org.ol3cesium.olx.layer.GroupLayerOptions;
...
public class GroupLayer extends BaseLayer {
    ...
    public static native GroupLayer create() /*-{
        ...
        group.set('className', @org.ol3cesium.ol.layer.BaseLayer::GROUP_LAYER_CLASS_NAME);
        return group;
    }-*/;
