...
import org.ol3cesium.ol.event.TileLayerChangeEventListener;
import org.ol3cesium.ol.source.TileSource;
...
public class TileLayer extends Layer {
    ...
    public static native TileLayer create() /*-{
        ...
        tile.set('className', @org.ol3cesium.ol.layer.BaseLayer::TILE_LAYER_CLASS_NAME);
        return tile;
    }-*/;
        ...
        if (!this.__tileLayerChangeEventListenerRegistered) {
            ...
            this.__notifyTileLayerChangeEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.TileLayerChangeEventListener::onTileLayerChange(Lorg/ol3cesium/ol/event/TileLayerChangeEvent;)(event);
                }
            };
        }
