...
import org.ol3cesium.ol.event.HeatmapLayerChangeEventListener;
import org.ol3cesium.olx.layer.HeatmapLayerOptions;
...
public class HeatmapLayer extends VectorLayer {
    ...
    public static native HeatmapLayer create() /*-{
        ...
        heatmap.set('className', @org.ol3cesium.ol.layer.BaseLayer::HEATMAP_LAYER_CLASS_NAME);
        return heatmap;
    }-*/;
        ...
        if (!this.__heatmapLayerChangeEventListenerRegistered) {
            ...
            this.__notifyHeatmapLayerChangeEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.HeatmapLayerChangeEventListener::onHeatmapLayerChange(Lorg/ol3cesium/ol/event/HeatmapLayerChangeEvent;)(event);
                }
            };
        }
