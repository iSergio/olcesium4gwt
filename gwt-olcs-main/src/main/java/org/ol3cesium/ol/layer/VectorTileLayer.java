...
import org.ol3cesium.ol.event.VectorTileLayerChangeEventListener;
import org.ol3cesium.olx.layer.VectorTileLayerOptions;
...
public class VectorTileLayer extends VectorLayer {
    ...
    public static native VectorTileLayer create() /*-{
        ...
        vectorTile.set('className', @org.ol3cesium.ol.layer.BaseLayer::VECTOR_TILE_LAYER_CLASS_NAME);
        return vectorTile;
    }-*/;
        ...
        if (!this.__vectorTileLayerChangeEventListenerRegistered) {
            ...
            this.__notifyVectorTileLayerChangeEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.VectorTileLayerChangeEventListener::onVectorTileLayerChange(Lorg/ol3cesium/ol/event/VectorTileLayerChangeEvent;)(event);
                }
            };
        }
