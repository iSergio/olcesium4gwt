...
import org.ol3cesium.ol.event.CollectionAddEventListener;
import org.ol3cesium.ol.event.CollectionRemoveEventListener;
        ...
        if (!this.__collectionAddEventListenerRegistered) {
            ...
            this.__notifyCollectionAddEventListeners = function(collectionAddEvent) {
                ...
                for (var i = 0; i < length;  i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.CollectionAddEventListener::onCollectionAdd(Lcom/google/gwt/core/client/JavaScriptObject;)(collectionAddEvent);
                }
            };
        }
        ...
        if (!this.__collectionRemoveEventListenerRegistered) {
            ...
            this.__notifyCollectionRemoveEventListeners = function(event) {
                ...
                for (var i = 0; i < length;  i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.CollectionRemoveEventListener::onCollectionRemove(Lcom/google/gwt/core/client/JavaScriptObject;)(event);
                }
            };
        }
