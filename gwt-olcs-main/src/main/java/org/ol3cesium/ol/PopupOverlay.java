...
import org.ol3cesium.ol.event.PopupOverlayCloserEventListener;
 ...
 * 
 * Example css places in gwt-ol3/src/main/resources/org/vaadin/gwtol3/resources/popup.css
 */
public class PopupOverlay extends Overlay {
    ...
    public final native void addPopupOverlayCloserEventListener(PopupOverlayCloserEventListener popupOverlayCloserEventListener) /*-{
        ...
        closer.onclick = function() {
            popupOverlayCloserEventListener.@org.ol3cesium.ol.event.PopupOverlayCloserEventListener::onPopupOverlayeCloser(Lorg/ol3cesium/ol/PopupOverlay;)(that);
        };
    }-*/;
}
