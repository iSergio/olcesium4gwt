...
import org.ol3cesium.ol.event.DragBoxInteractionEventListener;
import org.ol3cesium.ol.geom.Polygon;
import org.ol3cesium.olx.interaction.DragBoxInteractionOptions;
        ...
        if (!this.__dragBoxInteractionEventListenerRegistered) {
            ...
            this.__notifyDragBoxInteractionEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.DragBoxInteractionEventListener::onDragBoxInteraction(Lorg/ol3cesium/ol/event/DragBoxInteractionEvent;)(event);
                }
            };
        }
