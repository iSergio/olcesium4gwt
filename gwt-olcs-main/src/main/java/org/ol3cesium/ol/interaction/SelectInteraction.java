...
import org.ol3cesium.ol.event.SelectInteractionEventListener;
import org.ol3cesium.ol.layer.VectorLayer;
import org.ol3cesium.olx.interaction.SelectInteractionOptions;
        ...
        if (!this.__selectInteractionEventListenerRegistered) {
            ...
            this.__notifySelectInteractionEventListeners = function(event) {
                ...
                for(var i = 0; i < length; i++){
                    ...
                    listener.@org.ol3cesium.ol.event.SelectInteractionEventListener::onSelectInteraction(Lorg/ol3cesium/ol/event/SelectInteractionEvent;)(event);
                }
            };
        }
