...
import org.ol3cesium.ol.event.TranslateInteractionEventListener;
import org.ol3cesium.olx.interaction.TranslateInteractionOptions;
        ...
        if (!this.__translateInteractionEventListenerRegistered) {
            ...
            this.__notifyTranslateInteractionEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.TranslateInteractionEventListener::onTranslateInteraction(Lorg/ol3cesium/ol/event/TranslateInteractionEvent;)(event);
                }
            };
        }
