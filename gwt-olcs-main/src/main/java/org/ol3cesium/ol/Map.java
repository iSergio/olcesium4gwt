...
import org.ol3cesium.ol.control.Control;
import org.ol3cesium.ol.event.MapClickEventListener;
import org.ol3cesium.ol.event.MapPointerMoveEventListener;
import org.ol3cesium.ol.event.MapPostRenderEventListener;
import org.ol3cesium.ol.event.MouseMoveEventListener;
import org.ol3cesium.ol.geom.Geometry;
import org.ol3cesium.ol.interaction.Interaction;
import org.ol3cesium.ol.layer.BaseLayer;
import org.ol3cesium.ol.layer.GroupLayer;
        ...
        if (!this.__mouseMoveEventListenerRegistered) {
            ...
            this.__notifyMouseMoveEventListeners = function(mouseMoveEvent) {
                ...
                for (var i = 0; i < length;  i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.MouseMoveEventListener::onMouseMove(Lorg/ol3cesium/ol/event/MouseMoveEvent;)(mouseMoveEvent);
                }
            };
        }
        ...
        if (!this.__mapClickEventListenerRegistered) {
            ...
            this.__notifyMapClickEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.MapClickEventListener::onMapClick(Lorg/ol3cesium/ol/event/MapBrowserEvent;)(event);
                }
            }
        }
        ...
        if (!this.__mapPointerMoveEventListenerRegistered) {
            ...
            this.__notifyMapPointerMoveEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.MapPointerMoveEventListener::onMapPointerMove(Lorg/ol3cesium/ol/event/MapBrowserEvent;)(event);
                }
            }
        }
        ...
        if (!this.__mapPostRenderEventListenerRegistered) {
            ...
            this.__notifyMapPostRenderEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.MapPostRenderEventListener::onMapPostRender(Lorg/ol3cesium/ol/event/MapPostRenderEvent;)(event);
                }
            }
        }
