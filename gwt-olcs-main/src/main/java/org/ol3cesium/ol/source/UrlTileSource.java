...
import org.ol3cesium.ol.event.TileLoadEventListener;
        ...
        if (!this.__tileLoadEventListenerRegistered) {
            ...
            this.__notifyTileLoadEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.ol.event.TileLoadEventListener::onTileLoad(Lorg/ol3cesium/ol/event/TileLoadEvent;)(event);
                }
            };
        }
