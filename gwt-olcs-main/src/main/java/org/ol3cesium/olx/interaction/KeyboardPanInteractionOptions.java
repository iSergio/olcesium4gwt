 ...
 */
public class KeyboardPanInteractionOptions extends JavaScriptObject {
    protected KeyboardPanInteractionOptions() {
        //
    }
     ...
     * @param pixelDelta 
     */
    public final native void setPixelDelta(int pixelDelta) /*-{
