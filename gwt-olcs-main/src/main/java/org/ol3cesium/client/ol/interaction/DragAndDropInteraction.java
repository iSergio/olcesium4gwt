...
import org.ol3cesium.client.ol.event.DragAndDropInteractionEventListener;
        ...
        if (!this.__dragAndDropInteractionEventListenerRegistered) {
            ...
            this.__notifyDragAndDropInteractionEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.client.ol.event.DragAndDropInteractionEventListener::onDragAndDropInteraction(Lorg/ol3cesium/client/ol/event/DragAndDropInteractionEvent;)(event);
                }
            };
        }
