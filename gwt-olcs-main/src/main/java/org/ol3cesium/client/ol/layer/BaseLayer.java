...
import org.ol3cesium.client.olx.layer.BaseLayerOptions;
import org.ol3cesium.client.ol.Extent;
import org.ol3cesium.client.ol.Object;
import org.ol3cesium.client.ol.event.BaseLayerChangeEventListener;
...
public class BaseLayer extends Object {
    ...
    public static native BaseLayer create() /*-{
        ...
        base.set('className', @org.ol3cesium.client.ol.layer.BaseLayer::BASE_LAYER_CLASS_NAME);
        return base;
    }-*/;
        ...
        if (!this.__baseLayerChangeEventListenerRegistered) {
            ...
            this.__notifyBaseLayerChangeEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.client.ol.event.BaseLayerChangeEventListener::onBaseLayerChange(Lorg/ol3cesium/client/ol/event/BaseLayerChangeEvent;)(event);
                }
            };
        }
