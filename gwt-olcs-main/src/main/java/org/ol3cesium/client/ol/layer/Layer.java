...
import org.ol3cesium.client.olx.layer.LayerOptions;
...
public abstract class Layer extends BaseLayer {
    ...
    public static native Layer create(LayerOptions options) /*-{
        ...
        layer.set('className', @org.ol3cesium.client.ol.layer.BaseLayer::LAYER_LAYER_CLASS_NAME);
        return layer;
    }-*/;
        ...
        if (!this.__layerChangeEventListenerRegistered) {
            ...
            this.__notifyLayerChangeEventListeners = function(event) {
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    listener.@org.ol3cesium.client.ol.event.LayerChangeEventListener::onLayerChange(Lorg/ol3cesium/client/ol/event/LayerChangeEvent;)(event);
                }
            };
        }
