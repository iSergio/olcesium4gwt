...
public class OLCesiumScriptInjector extends AbstractLinker {
    private static String SCRIPT_LOADER = "loadOLCesiumScripts.js";
    private static String LOADED_SCRIPTS = "__gwt_olCesiumScriptsLoaded";
    private static String PAGE_RELATIVE_MODULE_PATH = "olCesiumScriptInjector.pageRelativeModulePath";
